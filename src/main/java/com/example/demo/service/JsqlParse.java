...
public class JsqlParse {
    ...
    public static void test_select(String sql) throws JSQLParserException {
        // *********select body items内容
        List<String> str_items = test_select_items(sql);

        // **********select table
        List<String> tableList = test_select_table(sql);

        // **********select table with join
        List<String> tablewithjoin = test_select_join(sql);

        // // *******select where
        String str = test_select_where(sql);

        // // ******select group by
        List<String> str_groupby = test_select_groupby(sql);

        // //**************select order by
        List<String> str_orderby = test_select_orderby(sql);
    ...
    public static void select_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            test_select(statement_list.get(i));
        }
    }
    ...
    public static void insert_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            test_insert(statement_list.get(i));
        }
    }
    ...
    public static void update_fromtxt() throws Exception {
        ...
        for (int i = 0; i < 1; i++) {
            test_update(statement_list.get(i));
        }
    }
